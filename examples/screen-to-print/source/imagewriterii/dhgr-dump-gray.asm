; DHGR (double hi-res) GREYSCALE screen dump -> ImageWriter II over the SSC.
; Companion to dhgr-dump-color.asm: same DHGR front-end (read aux+main, spread
; to 560 dots, classify the 4-dot cell into a 0..15 colour), but instead of
; ribbon-band overprint it maps each colour to an INK DENSITY (0=bare .. 16=
; solid) and ordered-dithers (4x4 Bayer) to 1 bit, emitting a single ESC G 0560
; pass per band. Higher colour fidelity in mono than a flat luma threshold.
;
