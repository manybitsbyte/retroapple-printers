  SCREEN TO PRINT - IMAGEWRITER I

These programs dump the Apple //e
graphics screen to an ImageWriter I
over the Super Serial Card in slot 2.
Black-and-white only - the ImageWriter
I has no colour ribbon.  For colour
use an ImageWriter II.
